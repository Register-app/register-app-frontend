  ...
  return (
    <Container className="justify-content-md-center min-vh-100">
      ...
      <Row className="text-center">
        <div class="row gy-3"> 
        <h3>Nowa wiadomość</h3><br/>
        </div>
        </Row>
        <Row>
        <Form>
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Label><b>Odbiorca</b> </Form.Label>
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
        <Form.Label><b>Treść</b></Form.Label>
        <Form.Control as="textarea" rows={5} />
      </Form.Group>
        <button type="button" onClick={handleClick} id='wyslijWiadomoscButton' class="btn btn-secondary">Wyślij</button>
    </Form>
        </Row>
