...
class App extends Component {
  ...
  render() {
    const { showHideSummary, showHideLogin, showHidePlanZajec, showHideFrekwencja, showHideWiadomosci,showHideOceny,showHideTerminarz } = this.state;
    return (
      <div class="row gy-4"> 
        <Header/>
      <Row>
        ...
        <Col className='col-md-1'></Col>
          ...
          <Col><button type="button" onClick={() => this.hideComponent("showHideOceny")}  class="btn btn-danger">Oceny</button></Col>
          <Col><button type="button" onClick={() => this.hideComponent("showHideTerminarz")} class="btn btn-success">Terminarz</button></Col>
          <Col><button type="button" onClick={() => this.hideComponent("showHideWiadomosci")} class="btn btn-warning">Wiadomości</button></Col>
